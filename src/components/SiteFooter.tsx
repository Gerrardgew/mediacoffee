    ...
    <footer className="bg-secondary text-secondary-foreground mt-24">
      <div className="mx-auto max-w-7xl px-6 py-16 grid md:grid-cols-4 gap-10">
        <div className="md:col-span-2">
          <img src={logo} alt="Me.dia" className="h-20 md:h-22 w-auto object-contain brightness-0 invert" />
        ...
        <div>
          ...
          <ul className="space-y-4 text-sm text-secondary-foreground/80">
            <li className="flex gap-2">
              ...
              <span>
                <span className="block text-secondary-foreground font-medium">Bencongan Indah</span>
                Jl. Palem Raja Raya, Kelapa Dua, Tangerang
              </span>
            </li>
            <li className="flex gap-2">
              <MapPin size={16} className="mt-0.5 shrink-0" />
              <span>
                <span className="block text-secondary-foreground font-medium">Sukasari</span>
                Jl. Ir. Sutami No.18, Kota Tangerang
              </span>
            </li>
